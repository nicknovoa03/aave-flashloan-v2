...
def main():
    ...
    if weth.balanceOf(flashloan) < MINIMUM_FLASHLOAN_WETH_BALANCE:
        ...
        weth.transfer(flashloan, ".01 ether", {"from": acct, "gas_limit": 400000, 'allow_revert': True})
    print("Executing Flashloan...")
    tx = flashloan.flashloan(weth, {"from": acct, "gas_limit": 400000, 'allow_revert': True})
